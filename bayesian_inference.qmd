...
4.  Which of the three components of Bayes' Theorem (prior, likelihood, posterior) are probability distributions which sum to 1.  Which are not? Explain why.
...
8.  If you calculate a Bayes Factor $BF_{10}$ of 12.5 in favor of an Alternative Hypothesis ($H_1$), how would you interpret this according to the classification scheme provided in this chapter?

9.  Explain the meaning of the Bayes Factor  $BF_{10}$ in the context of hypothesis testing. How does it differ from the $p$-value used in classical statistics?
