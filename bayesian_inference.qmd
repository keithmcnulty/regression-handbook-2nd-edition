...
Load the `ugtests` data set which we used in @sec-linear-reg-ols via the `peopleanalyticsdata` package or download it from the internet^[https://peopleanalytics-regression-book.org/data/ugtests.csv]. Remind yourself of what this data set contains.
