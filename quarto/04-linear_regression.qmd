...
Given that our new model only has three dimensions, we have the luxury of visualizing it.  `r if (knitr::is_latex_output()) '<!--'` Interactive `r if (knitr::is_latex_output()) '-->'` @fig-lin-reg-3d shows the data and the fitted plane of our model.  
