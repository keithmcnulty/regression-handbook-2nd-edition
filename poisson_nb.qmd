...
However, we know that overdispersion is present in our data, which could be a better explanation for the excess zeros, especially if we have no basis to support a structural reasobn.    So let's check whether there is zero-inflation in our negative binomial model.
