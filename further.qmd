...
If you have studied the later chapters of this book, I also encourage you to consider using some of the more advanced modeling techniques you have learned in those chapters to solve these problems.  For example, experiment with taking smaller samples from the data sets and using Bayesian methods to express the uncertainty that comes with these smaller samples.  Consider proposing a causal model for the data if you think one may be appropriate.  Test whether the data supports your causal model, and estimate any notable causal effects you may be interested in.  
