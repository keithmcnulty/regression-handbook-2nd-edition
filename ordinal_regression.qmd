...
Since our only values for $y$ are 1, 2 and 3, similar to our derivations in @sec-mod-prob, we conclude that $P(y > 1) = 1 - P(y = 1)$, which calculates to
