...
where $\binom{n}{k} = \frac{n!}{k!(n-k)!}$ is the binomial coefficient, which gives the number of ways of choosing $k$ successes from $n$ trials.  Here is the distribution of $Y$ for $n = 100$ and $p = 0.3$, shown in @fig-binomial-dist:
...
Binomial distribution showing the probability of $k$ successes in 100 trials with a success probability of 0.3 
:::
