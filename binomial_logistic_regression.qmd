...
Imagine that we have a set of observations of data that are binary or dichotomous in nature.  For convenience, let's call the two values the data can take 'success' and 'failure'.  Let's say that the probability of an observation being a success is $p$, and therefore the probability of an observation being a failure is $1 - p$.  
